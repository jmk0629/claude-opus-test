...
- **`admin`** → admin 전 메뉴(01~12) 배치 모드
- **`all`** → user+admin 전체 23개 (주의: 토큰 소비 큼, 2웨이브로 쪼개 실행 권장)
...
- admin: 01_MEMBER, 02_PRODUCT, 03_PARTNER, 04_SALES_AGENCY_PRODUCT, 05_PRESCRIPTION, 06_SETTLEMENT, 07_EXPENSE_REPORT, 08_COMMUNITY, 09_CONTENT_MANAGEMENT, 10_CUSTOMER_SERVICE, 11_BANNER, 12_ADMIN_PERMISSION
